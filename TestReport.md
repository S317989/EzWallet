...
| Registration Admin - Already Registered                                                              | Authentication - UsersAdmin                    | Unit        | wb - branches               |
| Registration Admin - Invalid Email                                                                   | Authentication - UsersAdmin                    | Unit        | wb - branches               |
| Login - Success | Users.login| Unit        |WB - Statement|
| Login - User Not Registered                                                                          | Users.login                            | Unit        | wb - branches               |
| Logout - Success                                                                                     | Users.logout                           | Unit        | WB - Statement              |
| Logout - Already logged out                                                                          | Users.logout                           | Unit        | wb - branches               |
| Logout - User not found                                                                              | Users.logout                           | Unit        | wb - branches               |
...
| Users                                                                                | usersMethods.createGroup                     | Unit        | wb - Statement              |
...
| Users - User in list                                                                 | User, Group                                  | integration | Black box, Positive         |
| Users - User not in list                                                             | User, Group                                  | integration | Black box, Positive         |
