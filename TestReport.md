...
| getUser - Success                      | User                                               | integration       | Black box, Positive  |
| getUser - Unauthorized - Refresh tokens don't match | User                                  | integration       | Black box, Negative  |
| getUser - User not found               | User                                               | integration       | Black box, Negative  |
| getUser (Admin) - Success              | User                                               | integration       | Black box, Positive  |
| getUser (Admin) - Unauthorized         | User                                               | integration       | Black box, Negative  |
| getUser (Admin) - User not found       | User                                               | integration       | Black box, Negative  |
| createGroup - Success - User in list   | User, Group                                        | integration       | Black box, Positive  |
| createGroup - Success - User not in list | User, Group                                      | integration       | Black box, Positive  |
| createGroup - Unauthorized             | Group                                              | integration       | Black box, Negative  |
| createGroup - Missing parameters       | Group                                              | integration       | Black box, Negative  |
| createGroup - Group already exists     | User, Group                                        | integration       | Black box, Negative  |
| createGroup - User already in a group  | User, Group                                        | integration       | Black box, Negative  |
| deleteGroup - Success                  | Group                                              | integration       | Black box, Positive  |
| deleteGroup - Unauthorized             | Group                                              | integration       | Black box, Negative  |
| deleteGroup - Group not found          | Group                                              | integration       | Black box, Negative  |
| addUserToGroup - Success               | User, Group                                        | integration       | Black box, Positive  |
| addUserToGroup - Unauthorized          | Group                                              | integration       | Black box, Negative  |
| addUserToGroup - User not found        | User, Group                                        | integration       | Black box, Negative  |
| removeUserFromGroup - Success          | User, Group                                        | integration       | Black box, Positive  |
| removeUserFromGroup - Unauthorized     | Group                                              | integration       | Black box, Negative  |
| removeUserFromGroup - User not found   | User, Group                                        | integration       | Black box, Negative  |
| authenticateUser - Success             | User                                               | integration       | Black box, Positive  |
| authenticateUser - User not found      | User                                               | integration       | Black box, Negative  |
| authenticateUser - Incorrect password  | User                                               | integration       | Black box, Negative  |
| authenticateUser - Missing parameters  | User                                               | integration       | Black box, Negative  |
| authenticateUser - Server error        | User                                               | integration       | Black box, Negative  |
| refreshToken - Success                 | User                                               | integration       | Black box, Positive  |
| refreshToken - User not found          | User                                               | integration       | Black box, Negative  |
| refreshToken - Server error            | User                                               | integration       | Black box, Negative  |
| updateUser - Success                   | User                                               | integration       | Black box, Positive  |
| updateUser - Unauthorized              | User                                               | integration       | Black box, Negative  |
| updateUser - User not found            | User                                               | integration       | Black box, Negative  |
| updateUser - Missing parameters        | User                                               | integration       | Black box, Negative  |
| updateUser - Server error              | User                                               | integration       | Black box, Negative  |
| deleteUser - Success                   | User                                               | integration       | Black box, Positive  |
| deleteUser - Unauthorized              | User                                               | integration       | Black box, Negative  |
| deleteUser - User not found            | User                                               | integration       | Black box, Negative  |
| deleteUser - Server error              | User                                               | integration       | Black box, Negative  |
| updateGroup - Success                  | Group                                              | integration       | Black box, Positive  |
| updateGroup - Unauthorized             | Group                                              | integration       | Black box, Negative  |
| updateGroup - Group not found          | Group                                              | integration       | Black box, Negative  |
| updateGroup - Missing parameters       | Group                                              | integration       | Black box, Negative  |
| updateGroup - Server error             | Group                                              | integration       | Black box, Negative  |
...
|Create Category - Success                   | API Endpoint, Route, crateCategory | Integration | BB - Statement Coverage |
|Create Category - Not enough attributes     | API Endpoint, Route, crateCategory | Integration | BB - Branch Coverage |
|Create Category - Type attributes is empty  | API Endpoint, Route, crateCategory | Integration | BB - Branch Coverage |
|Create Category - Category already exist    | API Endpoint, Route, crateCategory | Integration | BB - Branch Coverage |
|Create Category - Not an Admin              | API Endpoint, Route, crateCategory | Integration | BB - Branch Coverage |
|Update Category - Success                   | API Endpoint, Route, updateCategory | Integration | BB - Statement Coverage |
|Update Category - Invalid Parameters        | API Endpoint, Route, updateCategory | Integration | BB - Branch Coverage |
|Update Category - Empty Parameters          | API Endpoint, Route, updateCategory | Integration | BB - Branch Coverage |
|Update Category - Category doesn't exist    | API Endpoint, Route, updateCategory |Integration| BB - Branch Coverage |
|Update Category - New Category already exist| API Endpoint, Route, updateCategory |Integration| BB - Branch Coverage |
|Update Category - Not an Admin              | API Endpoint, Route, updateCategory |Integration| BB - Branch Coverage |
|Delete Category - Delete 1 - Success        | API Endpoint, Route, deleteCategory |Integration| BB - Statement Coverage |
|Delete Category - Delete Many - Success     | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Delete Category - Only 1 category in the DB | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Delete Category - At least 1 category is empty in input array| API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Delete Category - At least 1 category is not in the DB                | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Delete Category - Body doesn't contain all attributes                 | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Delete Category - Not Authenticated                                   | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Delete Category - Regular User Authenticated, not Admin               | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Get Categories - Success                                              | API Endpoint, Route, getCategory |Integration| BB - Statement Coverage |
|Get Categories - User not Authenticated                               | API Endpoint, Route, getCategory |Integration| BB - Branch Coverage |
|Create Transaction - Success                                          | API Endpoint, Route, createTransaction |Integration| BB - Statement Coverage |
|Create Transaction - Missing attributes                               | API Endpoint, Route, createTransaction |Integration| BB - Branch Coverage |
|Create Transaction - Empty body attributes                            | API Endpoint, Route, createTransaction |Integration| BB - Branch Coverage |
|Create Transaction - Category doesn't exist in the DB                 | API Endpoint, Route, createTransaction |Integration| BB - Branch Coverage |
|Create Transaction - Route Username doesn't match the request body    | API Endpoint, Route, createTransaction |Integration| BB - Branch Coverage |
|Create Transaction - Route Username is not in the DB                  | API Endpoint, Route, createTransaction |Integration| BB - Branch Coverage |
|Create Transaction - Body Username is not in the DB                   | API Endpoint, Route, createTransaction |Integration| BB - Branch Coverage |
|Create Transaction - Amount is not a float                            | API Endpoint, Route, createTransaction |Integration| BB - Branch Coverage |
|Create Transaction - Authenticated user doesn't match the user in body| API Endpoint, Route, createTransaction |Integration| BB - Branch Coverage |
|Get All Transaction - Success                                         | API Endpoint, Route, getAllTransaction |Integration| BB - Statement Coverage |
|Get All Transaction - No Transaction in the DB                        | API Endpoint, Route, getAllTransaction |Integration| BB - Branch Coverage |
|Get All Transaction - Authenticated Regular User, not an Admin        | API Endpoint, Route, getAllTransaction |Integration| BB - Branch Coverage |
|Get Transaction By User - Regular User - Success                                                 | API Endpoint, Route, getTransactionByUser |Integration| BB - Statement Coverage |
|Get Transaction By User - Admin - Success                                                        | API Endpoint, Route, getTransactionByUser |Integration| BB - Branch Coverage |
|Get Transaction By User - Admin - Username in params not in the DB                               | API Endpoint, Route, getTransactionByUser |Integration| BB - Branch Coverage |
|Get Transaction By User - Regular User - User authenticated and params doesn't match             | API Endpoint, Route, getTransactionByUser |Integration| BB - Branch Coverage |
|Get Transaction By User - Regular User - Admin route for an authorized regular user              | API Endpoint, Route, getTransactionByUser |Integration| BB - Branch Coverage |
|Get Transactions By User By Category - Regular User - Success                                    | API Endpoint, Route, getTransactionByUserByCategory |Integration| BB - Statement Coverage |
|Get Transactions By User By Category - Admin - Success                                           | API Endpoint, Route, getTransactionByUserByCategory |Integration| BB - Branch Coverage |
|Get Transactions By User By Category - Admin - Username in params not in the DB                  | API Endpoint, Route, getTransactionByUserByCategory |Integration| BB - Branch Coverage |
|Get Transactions By User By Category - Admin - Category in params not in the DB                  | API Endpoint, Route, getTransactionByUserByCategory |Integration| BB - Branch Coverage |
|Get Transactions By User By Category - Regular User - User authenticated and params doesn't match| API Endpoint, Route, getTransactionByUserByCategory |Integration| BB - Branch Coverage |
|Get Transactions By User By Category - Regular User - Admin route for an authorized regular user | API Endpoint, Route, getTransactionByUserByCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group - Regular User - Success                                      | API Endpoint, Route, deleteCategory |Integration| BB - Statement Coverage |
|Get Transactions By Group - Admin - Success                                             | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group - Admin - Group in params not in the DB                       | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group - Regular User - Authenticated User not part of the group     | API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group - Regular User - Admin Route for an authenticated Regular User| API Endpoint, Route, deleteCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group By Category - Regular User - Success                                      | API Endpoint, Route, getTransactionsByGroupByCategory |Integration| BB - Statement Coverage |
|Get Transactions By Group By Category - Admin - Success                                             | API Endpoint, Route, getTransactionsByGroupByCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group By Category - Admin - Group in params not in the DB                       | API Endpoint, Route, getTransactionsByGroupByCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group By Category - Admin - Category in params not in the DB                    | API Endpoint, Route, getTransactionsByGroupByCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group By Category - Regular User - Authenticated User not part of the group     | API Endpoint, Route, getTransactionsByGroupByCategory |Integration| BB - Branch Coverage |
|Get Transactions By Group By Category - Regular User - Admin Route for an authenticated Regular User| API Endpoint, Route, getTransactionsByGroupByCategory |Integration| BB - Branch Coverage |
|Delete Transaction - Success                                   | API Endpoint, Route, deleteTransaction |Integration| BB - Statement Coverage |
|Delete Transaction - Missing body attributes                   | API Endpoint, Route, deleteTransaction |Integration| BB - Branch Coverage |
|Delete Transaction - Username in params not in the DB          | API Endpoint, Route, deleteTransaction |Integration| BB - Branch Coverage |
|Delete Transaction - Transaction ID, in the body, not in the DB| API Endpoint, Route, deleteTransaction |Integration| BB - Branch Coverage |
|Delete Transaction - The user is not the owner                 | API Endpoint, Route, deleteTransaction |Integration| BB - Branch Coverage |
|Delete Transactions - Delete 1 - Success                       | API Endpoint, Route, deleteTransactions |Integration| BB - Statement Coverage |
|Delete Transactions - Delete many - Success                    | API Endpoint, Route, deleteTransactions |Integration| BB - Branch Coverage |
|Delete Transactions - Missing body attributes                  | API Endpoint, Route, deleteTransactions |Integration| BB - Branch Coverage |
|Delete Transactions - 1 attribute is empty                     | API Endpoint, Route, deleteTransactions |Integration| BB - Branch Coverage |
|Delete Transactions - Transaction ID in the body not in the DB | API Endpoint, Route, deleteTransactions |Integration| BB - Branch Coverage |
|Delete Transactions - Not authenticated                        | API Endpoint, Route, deleteTransactions |Integration| BB - Branch Coverage |
